...
public class VideoStreamProcessor {
  ...
  public static void main(String[] args) throws Exception {
	...
	//process
	Dataset<VideoEventData> processedDataset = kvDataset.mapGroups(new MapGroupsFunction<String, VideoEventData, VideoEventData>(){
		@Override
		public VideoEventData call(String key, Iterator<VideoEventData> values) throws Exception {
